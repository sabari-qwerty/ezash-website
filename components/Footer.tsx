...
export const Footer: FC = () => {
  return (
    <footer className="flex flex-col space-y-16">
      ...
      <div className="flex   lg:justify-between  justify-center   flex-col lg:flex-row space-y-6 lg:space-y-0">
        {Contact.map((data, key) => (
          <a
            ...
            target="_blank"
            key={key}
            className="flex justify-center items-center space-x-4  bg-[#00000017] py-2 px-4 hover:bg-[#FFA600] text-[#fff] hover:text-gray-700 "
          >
